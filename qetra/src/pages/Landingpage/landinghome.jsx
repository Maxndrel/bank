        ...
        <Container fluid className="px-md-5 py-3">
          <Row className="align-items-center">
            ...
            <Col xs={12} lg={6} className="position-relative">
              ...
              {/* Absolutely positioned bottom features */}
          ...
          <Carousel.Item>
            <div className="text-center">
              ...
              <blockquote className="blockquote">
                ...
                <footer className="blockquote-footer">Jame K. <cite title="Source Title">Entrepreneur</cite></footer>
              </blockquote>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item>
            <div className="text-center">
              ...
              <blockquote className="blockquote">
                ...
                <footer className="blockquote-footer">Amina O. <cite title="Source Title">Freelancer</cite></footer>
              </blockquote>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item>
            <div className="text-center">
              ...
              <blockquote className="blockquote">
                ...
                <footer className="blockquote-footer">Michael T. <cite title="Source Title">Student</cite></footer>
              </blockquote>
            </div>
          </Carousel.Item>
        </Carousel>
